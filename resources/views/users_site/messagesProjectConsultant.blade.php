@extends('layout_messagesBetweenProjectConsultant.app')
@section('content')
<div id="myModalIndicator" class="modalIndicator">
    <div class="modal-contentIndicator">
        <span class="closeIndicator">&times;</span>
            <form id="registerNewFilesConsultant33" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4 borda">
                        <div class="filesss" id="files">
                            ...
                            <input type="hidden" id="request_id" value="{{Session::get('id')}}" />
...
<script>
      $.ajaxSetup({
        ...
        $('#registerNewFilesConsultant33').submit(function(e) {
            e.preventDefault();
            ...
            if(TotalImages == ""){
                ...
                $.ajax({
                    type:'POST',
                    url: "/storeProjectToProjectFiles",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,

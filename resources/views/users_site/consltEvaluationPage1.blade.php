@extends('layout_consltEvaluationPage1.app')
@section('content')
<div id="myModaConsultantProject" class="modalConsultantProject">
    ...
    <div class="login-tab-body">
        <div class="row tabitem btab tab1">
            <div class="col-md-8">
                <form id="registerNewFilesConsultant22" enctype="multipart/form-data">
                    @csrf
                    <div class="bords">
...
var fullLength=0;
    if (window.File && window.FileList && window.FileReader) {
      ...
      $.ajaxSetup({
        ...
        $('#registerNewFilesConsultant22').submit(function(e) {
            e.preventDefault();

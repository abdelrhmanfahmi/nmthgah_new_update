...
<script>
      $.ajaxSetup({
        ...
        $('#registerNewFilesConsultant44').submit(function(e) {
            e.preventDefault();
            ...
            if(TotalImages == ""){
                ...
                $.ajax({
                    type:'POST',
                    url: "/storeAdminConsultantMessagesFiles",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,

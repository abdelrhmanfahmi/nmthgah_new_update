...
<div id="app">
    <section class="login-page">
        <div class="container">
            ...
            <a id="mainPage-project-manager2" href="/manager"><i style="margin-left:10px;" class="fa fa-home"></i> الرئيسية </a>
            <a id="logout-project-manager2" href="{{route('project.logout')}}">تسجيل خروج <i class="fas fa-sign-out-alt"></i></a>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1"></div>
            </nav>
            <div class="loginco">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 resize">
                        <div class="project-manager2">
                            ...
                            <nav id="sidebar1">
                                    ...
                                    <div class="row firstRow-project-manager2">
                                        @foreach($showPillarProjectManager as $index => $pillarManager)
                                        <div class="col-md-6 putDataPillar">
                                            <div @if($index % 2 == 0) class="firstBorder-project-manager2" @else class="secondBorder-project-manager2" @endif>
                                                @if($pillarManager->name == 'الركن الاستثماري')
                                                <img id="ImageBorderGroup-project-manager2" src="{{asset('assets/images/Group 33303.png')}}" width="78px" height="75px" alt="">
                                                @elseif($pillarManager->name == 'الركن الهندسي')
                                                <img id="ImageBorderGroup-project-manager2" src="{{asset('assets/images/Group 33304.png')}}" width="78px" height="75px" alt="">
                                                @elseif($pillarManager->name == 'الركن المؤسسي')
                                                <img id="ImageBorderGroup-project-manager2" src="{{asset('assets/images/Group 33305.png')}}" width="78px" height="75px" alt="">
                                                @else
                                                <img id="ImageBorderGroup-project-manager2" src="{{asset('assets/images/Group 3308.png')}}" width="78px" height="75px" alt="">
                                                @endif
                                                <span class="firstBorderSpanName">{{$pillarManager->first_name}}</span>
                                                <div @if($index % 2 == 0) class="setProject-project-manager2" @else class="setProject2-project-manager2" @endif>{{$pillarManager->name}}</div>
                                                
                                            </div>
                                            <a href="/showStandardPillars/{{$pillarManager->id}}/{{$pillarManager->request_id}}/{{$pillarManager->pillar_id}}" @if($index % 2 == 0) id="btnHomeUser-project-manager2" @else id="btnHomeUser2-project-manager2" @endif>النتيجة</a>
                                        </div>
                                        @endforeach
                                   </div>
    ...
    <script>
        $(document).ready(function(){
            var counter = $('.putDataPillar').length;

                ...
                <div class="loginco">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="evaluat-request">
                            <h3>خدمة التأسيس المعياري</h3>
                            <form id="registerDataEstablish" class="formsInputsAll">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-3 formas3">
                                        <input type="text" name="waqf" class="input3" id="waqf" placeholder="@error('waqf') {{$message}} @else اسم الوقف @enderror"/>
                                ...
                                <div class="row">
                                    <div class="col-md-12 formas5">
                                        <textarea name="description" id="description" cols="50" rows="3" class="input5" placeholder="@error('description') {{$message}} @else وصف التأسيس المعياري للوقف @enderror"></textarea>
                                    </div>
                                </div>
                                <button type="submit" onclick="SaveDataEstablish();" class="buttonForSubmitInfo">حفظ</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        $('#registerDataEstablish').on('submit' , function(e){
            e.preventDefault();
        });
    ...
    function SaveDataEstablish(){
        ...
        if(name == "" || email == "" || waqf == "" || city == "" || description == ""){
            ...
            $.ajax({
                url:'/saveDataOfEstablish',
                method:'POST',
                data:{_token: "{{ csrf_token() }}" , name:name, email:email, waqf:waqf, city:city, description:description},
                success:function(response){
                    if(response == 1){
                        $('#name').val("");$('#email').val("");$('#waqf').val("");$('#city').val("");$('#description').val("");
    ...
    //action="{{route('result.store')}}" method="POST"
</script>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-block">
                <form method="POST" action="{{ url('admin/updateAdmins/' . $admins->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    <div class="form-body">
                        <hr>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb5">
                                            ...
                                            <input type="number" value="{{$admins->phone}}" name="phone" class="form-control">
                                        </div>
                                    </div>
                                </div><!-- col12 -->

...
<div class="messages-form">
    <div class="col-md-12 containers" id="containers">
        ...
        <div class="messages">
            ...
            @if(pathinfo($msg->files, PATHINFO_EXTENSION) == 'pdf')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="secondDownAdmin mdi mdi-download"></i> </a><span class="downloadSpan2Admin">تحميل</span> <p class="pSecondMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><embed class="imgRightMessages2" src="{{asset('uploads/' . $msg->files)}}" /> </a> <span class="time-right">{{$msg->created_at}}</span></p>
            @elseif(pathinfo($msg->files, PATHINFO_EXTENSION) == 'docx' || pathinfo($msg->files, PATHINFO_EXTENSION) == 'doc')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessagesAdmin mdi mdi-download"></i> </a><span class="downloadSpan1Admin">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('assets/images/wordForPreview.jpg')}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @elseif(pathinfo($msg->files, PATHINFO_EXTENSION) == 'pptx' || pathinfo($msg->files, PATHINFO_EXTENSION) == 'ppt')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessagesAdmin mdi mdi-download"></i> </a><span class="downloadSpan1Admin">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('assets/images/pptxForPreview.jpg')}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @else
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessagesAdmin mdi mdi-download"></i> </a><span class="downloadSpan1Admin">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('uploads/' . $msg->files)}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @endif
            @else
        ...
        <div class="messages darkerMessages">
            ...
            @if($msg->files != null)
            @if(pathinfo($msg->files, PATHINFO_EXTENSION) == 'pdf')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="secondDown mdi mdi-download"></i> </a><span class="downloadSpan2">تحميل</span> <p class="pSecondMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><embed class="imgRightMessages2" src="{{asset('uploads/' . $msg->files)}}" /> </a> <span class="time-right">{{$msg->created_at}}</span></p>
            @elseif(pathinfo($msg->files, PATHINFO_EXTENSION) == 'docx' || pathinfo($msg->files, PATHINFO_EXTENSION) == 'doc')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessages mdi mdi-download"></i> </a><span class="downloadSpan1">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('assets/images/wordForPreview.jpg')}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @elseif(pathinfo($msg->files, PATHINFO_EXTENSION) == 'pptx' || pathinfo($msg->files, PATHINFO_EXTENSION) == 'ppt')
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessages mdi mdi-download"></i> </a><span class="downloadSpan1">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('assets/images/pptxForPreview.jpg')}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @else
                <a href="/downloadImagsMessagesUser/{{$msg->id}}"> <i class="firstDownMessages mdi mdi-download"></i> </a><span class="downloadSpan1">تحميل</span> <p class="pFirstMessages"><a href="/showImagesMessagesUser/{{$msg->id}}" target="_blank"><img class="imgRightMessages" src="{{asset('uploads/' . $msg->files)}}" width="60px" height="30px"></a> <span class="time-right newTimeRight">{{$msg->created_at}}</span></p>
            @endif
            @else
    ...
    <div class="row">
        <div class="col-md-12 textareaMessage">
            <form action="{{route('messagesUser.Store')}}" id="myFormID" method="POST">
                @csrf
                ...
                <input type="hidden" name="user_id" value="{{request()->id1}}" >
    ...
    <div id="myModalIndicator" class="modalIndicator">
                <div class="modal-contentIndicator">
                    <span class="closeIndicator">&times;</span>
                        <form id="registerFilesHere2" enctype="multipart/form-data">
                            @csrf
                            <div class="bords">
...
<script>
    ...
    $('#registerFilesHere2').submit(function(e) {
        e.preventDefault();
        ...
        if(TotalImages == ""){
            ...
            $.ajax({
                type:'POST',
                url: "/admin/storeMessageFromAdminToUserFiles",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
    ...
    //action="{{route('messagesUserFile.Store')}}" method="POST"
});

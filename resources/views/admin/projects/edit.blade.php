    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-block">
                <form method="POST" action="{{ url('admin/updateManagers/' . $projects->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <hr>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb5">
                                            ...
                                            <input type="text" name="first_name" value="{{$projects->first_name}}" class="form-control">
                                        </div>
                                    </div>
                                </div><!-- col12 -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb5">
                                            <div class="input-group-addon"><i class="fa fa-user-circle"></i></div>
                                            <input type="text" name="last_name" value="{{$projects->last_name}}" class="form-control">
                                        </div>
                                    </div>
                                </div><!-- col12 -->
                            </div><!-- col6 -->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb5">
                                            ...
                                            <input type="text" name="email" value="{{$projects->email}}" class="form-control">
                                        </div>
                                    </div>
                                </div><!-- col12 -->
                                <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb5">
                                        ...
                                        <input type="text" name="phone" id="phone" value="{{$projects->phone}}" class="form-control">
                                    </div>
                                </div>
                            </div>

    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-block">
                ...
                <form method="POST" action="{{route('consulManag.store')}}">
                    @csrf
                    <div class="form-body">
                        <hr>
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb5">
                                            ...
                                            <input type="text" name="waqf" value="" class="form-control">
                                        </div>
                                    </div>
                                </div><!-- col12 -->
                            </div><!-- col6 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">وصف الاستشارة الإدارية للوقف</label>
                                    <div class="input-group mb5">

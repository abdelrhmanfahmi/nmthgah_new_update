...
<div class="container">
    @if(count($courseShowPaid) < 1) <div class="row">
        <div class="col-md-12">
...
<div class="container bg-white">
    ...
    <br>
    @foreach($courseShowPaid as $courseGuest)
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 d-flex flex-column mb-3">
            ...
            <a href="/showImagePaidCourse/{{$courseGuest->id}}" target="_blank"><img style="border-radius:30px;border:2px solid #ddd;width:210px;height:140px;" class="img-fluid" src="{{asset('uploads/' . $courseGuest->bankImage)}}"/></a>
        </div>
    </div>
    <br>
    <div class="col-md-12">

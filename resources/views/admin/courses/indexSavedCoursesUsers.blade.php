                        ...
                        <tbody>
                            @if(count($courseGuests) < 1)<tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="showCourseSaved/{{$course->id}}/{{$course->guests->id}}" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="تفاصيل"><i class="mdi mdi-eye" aria-hidden="true"></i></a>
                                        <form style="display:inline;" method="POST" action="deleteCourseSaved/{{$course->guests->id}}">
                                            {{ csrf_field() }}
                                            @method('DELETE')
